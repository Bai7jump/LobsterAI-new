...
interface IElectronAPI {
  ...
  openClawTeam: {
    listInstances: () => Promise<{ success?: boolean; instances?: import('./openClawTeam').OpenClawInstance[]; error?: string }>;
    startInstance: (request: { instanceId: string }) => Promise<{ success?: boolean; instance?: import('./openClawTeam').OpenClawInstance; error?: string }>;
    stopInstance: (request: { instanceId: string }) => Promise<{ success?: boolean; error?: string }>;
    createInstance: (request: {
      name: string;
      type?: 'general' | 'specialized';
      capabilities?: string[];
      config?: any;
    }) => Promise<{ success?: boolean; instance?: import('./openClawTeam').OpenClawInstance; error?: string }>;
    deleteInstance: (request: { instanceId: string }) => Promise<{ success?: boolean; error?: string }>;
    submitTask: (request: { input: any; scheduledTaskId?: string }) => Promise<{ success?: boolean; task?: import('./openClawTeam').TeamTask; error?: string }>;
    getTaskStatus: (request: { taskId: string }) => Promise<{ success?: boolean; task?: import('./openClawTeam').TeamTask; error?: string }>;
    listTasks: (request?: {
      filter?: {
        status?: string;
        assignedTo?: string;
    ...
    }) => Promise<{ success?: boolean; tasks?: import('./openClawTeam').TeamTask[]; total?: number; error?: string }>;
    getConfig: () => Promise<{ success?: boolean; config?: import('./openClawTeam').TeamConfig; error?: string }>;
    updateConfig: (request: { config: any }) => Promise<{ success?: boolean; config?: import('./openClawTeam').TeamConfig; error?: string }>;
    subscribe: () => void;
    unsubscribe: () => void;
    onEvent: (callback: (event: import('./openClawTeam').OpenClawTeamEvent) => void) => () => void;
  };
  app: {
  ...
  scheduledTasks: {
    ...
    createWithInstance: (input: import('./scheduledTask').ScheduledTaskInput, instanceId?: string) => Promise<{ success: boolean; task?: import('./scheduledTask').ScheduledTask; error?: string }>;
    ...
    runOnInstance: (taskId: string, instanceId?: string) => Promise<{ success: boolean; error?: string }>;
