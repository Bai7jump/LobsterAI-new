...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    scheduledTasksUseTemplate: '使用模板',
    scheduledTasksTemplatesTitle: '选择模板',
    scheduledTasksTemplatesAll: '全部',
    scheduledTasksTemplatesNone: '该分类下暂无模板',
    ...
    // 实例选择器相关
    scheduledTasksInstanceSelectorTitle: '实例分配配置',
    scheduledTasksInstanceStrategy: '分配策略',
    scheduledTasksInstanceStrategyRoundRobin: '轮询',
    scheduledTasksInstanceStrategyLeastLoaded: '最少负载',
    scheduledTasksInstanceStrategyCapabilityBased: '能力匹配',
    scheduledTasksInstanceStrategyAffinityTag: '亲和标签',
    scheduledTasksInstanceStrategyManual: '手动选择',
    scheduledTasksInstanceSelectInstance: '目标实例',
    scheduledTasksInstanceSelectInstancePlaceholder: '请选择运行实例',
    scheduledTasksInstanceStatusIdle: '空闲',
    scheduledTasksInstanceStatusBusy: '繁忙',
    scheduledTasksInstanceStatusUnavailable: '不可用',
    scheduledTasksInstanceNoInstancesAvailable: '暂无可用实例，请先启动实例',
    scheduledTasksInstanceAffinityTags: '亲和标签',
    scheduledTasksInstanceAffinityTagsPlaceholder: '输入标签，按Enter添加',
    scheduledTasksInstanceAffinityTagsHelp: '任务将优先分配到包含所有指定标签的实例',
    scheduledTasksInstanceCapabilityRequirementsHelp: '任务将自动分配到满足所有能力要求的实例',
    scheduledTasksInstanceRequiredModels: '模型要求',
    scheduledTasksInstanceRequiredModelsPlaceholder: '输入模型名称，按Enter添加',
    scheduledTasksInstanceRequiredSkills: '技能要求',
    scheduledTasksInstanceRequiredSkillsPlaceholder: '输入技能名称，按Enter添加',
    scheduledTasksInstanceRequiredPlatforms: '平台要求',
    scheduledTasksInstanceRequiredPlatformsPlaceholder: '输入平台名称，按Enter添加',
    scheduledTasksInstanceMinMemoryMB: '最小内存要求 (MB)',
    scheduledTasksInstanceMinMemoryMBPlaceholder: '输入最小内存大小',
    scheduledTasksInstanceRetryStrategy: '重试策略',
    scheduledTasksInstanceMaxRetries: '最大重试次数',
    scheduledTasksInstanceRetryDelayMs: '重试延迟 (毫秒)',
    scheduledTasksInstanceFailoverToOtherInstance: '实例故障时自动转移到其他实例',

    // OpenClaw 团队管理
    openClawTeam: 'OpenClaw 团队',
    openClawTeamTitle: '🤖 OpenClaw 团队管理',
    openClawTeamEnabled: '团队已启用',
    openClawTeamDisabled: '团队已禁用',
    openClawTeamAddInstance: '+ 添加实例',
    openClawTeamOverview: '📊 团队概览',
    openClawTeamOnlineInstances: '在线实例:',
    openClawTeamRunningTasks: '运行中任务:',
    openClawTeamQueuedTasks: '队列中:',
    openClawTeamSchedulingStrategy: '调度策略:',
    openClawTeamInstanceList: '实例列表',
    openClawTeamCurrentTasks: '当前任务:',
    openClawTeamCompleted: '已完成:',
    openClawTeamMemory: '内存:',
    openClawTeamCPU: 'CPU:',
    openClawTeamStart: '启动',
    openClawTeamStop: '停止',
    openClawTeamTaskQueue: '任务队列',
    openClawTeamTask: '任务',
    openClawTeamAssignedTo: '分配至:',
    openClawTeamPriority: '优先级:',
    openClawTeamAddInstanceModal: '添加实例',
    openClawTeamInstanceName: '实例名称',
    openClawTeamInstanceNamePlaceholder: '输入实例名称',
    openClawTeamCreate: '创建',
    openClawTeamLoading: '加载中...',
    openClawTeamStatusIdle: 'idle',
    openClawTeamStatusBusy: 'busy',
    openClawTeamStatusError: 'error',
    openClawTeamStatusStarting: 'starting',
    openClawTeamStatusStopped: 'stopped',
    openClawTeamSchedulingRoundRobin: 'round-robin',
    openClawTeamSchedulingLeastLoaded: 'least-loaded',
    openClawTeamSchedulingCapabilityMatch: 'capability-match',
  ...
  en: {
    ...
    scheduledTasksUseTemplate: 'Use Template',
    scheduledTasksTemplatesTitle: 'Choose a Template',
    scheduledTasksTemplatesAll: 'All',
    scheduledTasksTemplatesNone: 'No templates in this category',
    ...
    // Instance selector
    scheduledTasksInstanceSelectorTitle: 'Instance Allocation Configuration',
    scheduledTasksInstanceStrategy: 'Assignment Strategy',
    scheduledTasksInstanceStrategyRoundRobin: 'Round Robin',
    scheduledTasksInstanceStrategyLeastLoaded: 'Least Loaded',
    scheduledTasksInstanceStrategyCapabilityBased: 'Capability Based',
    scheduledTasksInstanceStrategyAffinityTag: 'Affinity Tag',
    scheduledTasksInstanceStrategyManual: 'Manual Selection',
    scheduledTasksInstanceSelectInstance: 'Target Instance',
    scheduledTasksInstanceSelectInstancePlaceholder: 'Select running instance',
    scheduledTasksInstanceStatusIdle: 'Idle',
    scheduledTasksInstanceStatusBusy: 'Busy',
    scheduledTasksInstanceStatusUnavailable: 'Unavailable',
    scheduledTasksInstanceNoInstancesAvailable: 'No available instances, please start an instance first',
    scheduledTasksInstanceAffinityTags: 'Affinity Tags',
    scheduledTasksInstanceAffinityTagsPlaceholder: 'Enter tag, press Enter to add',
    scheduledTasksInstanceAffinityTagsHelp: 'Tasks will be preferentially assigned to instances with all specified tags',
    scheduledTasksInstanceCapabilityRequirementsHelp: 'Tasks will be automatically assigned to instances that meet all capability requirements',
    scheduledTasksInstanceRequiredModels: 'Model Requirements',
    scheduledTasksInstanceRequiredModelsPlaceholder: 'Enter model name, press Enter to add',
    scheduledTasksInstanceRequiredSkills: 'Skill Requirements',
    scheduledTasksInstanceRequiredSkillsPlaceholder: 'Enter skill name, press Enter to add',
    scheduledTasksInstanceRequiredPlatforms: 'Platform Requirements',
    scheduledTasksInstanceRequiredPlatformsPlaceholder: 'Enter platform name, press Enter to add',
    scheduledTasksInstanceMinMemoryMB: 'Minimum Memory (MB)',
    scheduledTasksInstanceMinMemoryMBPlaceholder: 'Enter minimum memory size',
    scheduledTasksInstanceRetryStrategy: 'Retry Strategy',
    scheduledTasksInstanceMaxRetries: 'Max Retries',
    scheduledTasksInstanceRetryDelayMs: 'Retry Delay (ms)',
    scheduledTasksInstanceFailoverToOtherInstance: 'Auto failover to other instances on failure',
